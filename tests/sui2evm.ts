...
async function main() {
  ...
  // console.log('Announcing order on Sui chain...')
  // const announce_Order = await announceStandardOrder(hash)
  // const orderId = announce_Order?.toString()
  // if (!orderId) throw new Error('Failed to announce order')
  // console.log('Order ID:', orderId)

  // console.log('Starting auction...')
  // const duchAuction = await auctionTick(orderId)
  // console.log('Auction ticked, price:', duchAuction)

  // console.log('Filling order...')
  // await fillStandardOrder(orderId)

  // console.log('Creating HTLC on Sui...')
  // const htlcSrc = await createHTLCSrc(hash, orderId, suiAddressResolver)
  // const htlcId = htlcSrc?.toString()
  // if (!htlcId) throw new Error('Failed to create HTLC')

  // console.log('Adding safety deposit...')
  // await addSafetyDeposit(htlcId)
