...
export async function main(htlcId: string,dst:Chain,dstChainUser: Wallet, dstChainResolver: Wallet, resolverInstance: Resolver, dstFactory: EscrowFactory, hashLock: Sdk.HashLock) {
...
export async function claim(htlcId: string, secret: string, dstChainResolver:Wallet, resolverInstance: Resolver, dstEscrowAddress: Sdk.Address, dstImmutables: Sdk.Immutables, dstDeployedAt: bigint){
